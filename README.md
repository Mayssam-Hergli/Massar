...
<p align="center">
  <img src="docs/system_design1.svg" width="750" height="700" alt="System Architecture"/>
</p>
...
4 Microservices — each is its own FastAPI app (can run as separate containers):
...
EXP: The Export Service generates downloadable PDF reports and PNG summary images from the entrepreneur's diagnostic for styled documents and Pillow/html2image for visual snapshots.
